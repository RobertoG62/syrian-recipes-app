    ...
    function updateStaticText() {
        ...
        if (heroTitle) {
            heroTitle.innerHTML = i18n.getLanguage() === 'he' ?
                'המטבח <span class="text-sy-primary-light">הסורי</span>' :
                '<span class="text-sy-primary-light">Syrian</span> Cuisine';
        }
        ...
        if (footerText) {
            footerText.innerHTML = i18n.t('footer.tagline') + ' <span class="text-sy-primary-light mx-1"><i class="fas fa-heart"></i></span>';
        }
